...
function DeletarProduto() {
    ...
    return (
        <div className='container h-[50vh] w-full max-w-md mx-auto px-4 pt-20 md:pt-6'>
            ...
            <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
                ...
                <div className="flex flex-row">
                    ...
                    <button
                        className='w-full text-slate-100 bg-indigo-400 hover:bg-indigo-700 flex items-center justify-center text-base md:text-lg'
