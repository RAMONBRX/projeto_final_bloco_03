...
function DeletarCategoria() {
    ...
    return (
        <div className='container h-[50vh] w-full max-w-md px-4 pt-4 mx-auto md:pt-6'>
            ...
            <div className='flex flex-col justify-between overflow-hidden border rounded-2xl'>
                ...
                <div className="flex flex-row">
                    ...
                    <button
                        className='flex items-center justify-center w-full text-base bg-indigo-400 text-slate-100 hover:bg-indigo-700 md:text-lg'
